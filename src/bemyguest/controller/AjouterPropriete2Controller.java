 ...
 *
 */
public class AjouterPropriete2Controller implements Initializable {
...
//        }
        ...
        if (verif == 0) {
            Parent form2 = FXMLLoader.load(getClass().getResource("/bemyguest/gui/AjouterPropriete3.fxml"));
...
//        }
    ...
    private void retour(ActionEvent event) throws IOException {
        Parent form = FXMLLoader.load(getClass().getResource("/bemyguest/gui/AjouterPropriete1.fxml"));
